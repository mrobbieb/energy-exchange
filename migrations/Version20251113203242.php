 ...
 */
final class Version20251113203242 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__energy_transaction AS SELECT id, battery_id, user_id, battery_bank_id, created_at, updated_at, watts FROM energy_transaction');
        ...
        , watts INTEGER NOT NULL, CONSTRAINT FK_3807D00B19A19CFC FOREIGN KEY (battery_id) REFERENCES battery (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3807D00BA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3807D00BFE25EA57 FOREIGN KEY (battery_bank_id) REFERENCES battery_bank (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO energy_transaction (id, battery_id, user_id, battery_bank_id, created_at, updated_at, watts) SELECT id, battery_id, user_id, battery_bank_id, created_at, updated_at, watts FROM __temp__energy_transaction');
